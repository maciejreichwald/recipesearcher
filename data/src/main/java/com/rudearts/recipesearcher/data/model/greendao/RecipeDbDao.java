...
*/
public class RecipeDbDao extends AbstractDao<RecipeDb, Long> {

    public static final String TABLENAME = "recipe";

    /**
     * Properties of entity RecipeDb.<br/>
    ...
    public RecipeDbDao(DaoConfig config) {
        super(config);
    }
    
    public RecipeDbDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, RecipeDb entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, RecipeDb entity) {
        stmt.clearBindings();
    ...
    @Override
    public RecipeDb readEntity(Cursor cursor, int offset) {
        RecipeDb entity = new RecipeDb( //
    ...
    @Override
    public void readEntity(Cursor cursor, RecipeDb entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(RecipeDb entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(RecipeDb entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(RecipeDb entity) {
